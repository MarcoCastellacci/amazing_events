...
async function getData() {
    ...
    let currenDate = amazingEvents.currentDate;
    ...
    let searchText = "";
    let dataArray = [];
    let eventosPasados = amazing.filter(pastEvents => pastEvents.date < currenDate)
    let eventosFuturos = amazing.filter(futureEvents => futureEvents.date > currenDate)
    var id = 1
